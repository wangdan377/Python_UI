...
send_mail = SendEmail(
        ...
        passwd='BQEUUTJPJXWKNWBL',
        recv=['1065913054@qq.com'],
        title='API自动化测试报告邮件',
        content='测试发送邮件',
        file=r'D:\ZYCami_00\Report\report.html',
        ssl=True,
    )
...
class AllTest:#定义一个类AllTest
    def __init__(self):#初始化一些参数和数据
        ...
        self.caseFile = os.path.join(path, "TestCase_prime")#真正的测试断言文件路径
        self.caseList = []
    ...
    def run(self):
        ...
        try:
            ...
            if suit is not None:#判断test_suite是否为空
                ...
                runner = HTMLTestRunnerCN3_pie_chart_screen.HTMLTestRunner(stream=fp, title='UI测试报告', tester='王丹',
