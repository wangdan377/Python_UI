...
class OperateElement:
    ...
    #     print("向右滑动")
    #     self.swipe_by_ratio(start_x, start_bottom, 'right', 0.5, 5000)
    #     return {"result": True}
    ...
    def elements_by(self, mOperate):
        ...
        elements = {
            ...
            be.find_elements_by_path: lambda: self.driver.find_elements_by_xpath(mOperate["element_info"])[mOperate['index']],
